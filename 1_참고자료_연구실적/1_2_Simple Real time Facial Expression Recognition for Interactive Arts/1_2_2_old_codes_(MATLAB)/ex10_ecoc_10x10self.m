...
%% train
svm = fitcecoc(total_train_mats, total_train_class);

%% testing
total_test_rst = svm.predict(total_train_mats);

[errorsum_test t_accu] = getaccuracy(total_test_rst,total_train_class);
%% show
figure; 
set(gcf, 'Position',  [500, 10, 700, 700]);

Ct= confusionmat(total_train_class, total_test_rst);
