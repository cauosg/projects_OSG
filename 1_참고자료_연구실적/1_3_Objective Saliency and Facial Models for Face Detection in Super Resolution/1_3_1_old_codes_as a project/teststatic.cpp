...
void main()
{
	...
	Size reduced(img.cols / minrect, img.rows / minrect);
	...
	regshow("sal0", sal0, procsize);
	regshow("sal1", sal1, procsize);
	regshow("sal2", sal2, procsize);
